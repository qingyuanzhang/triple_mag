...
$.fn.ProxyAddress = function(){
	...
	//插入3个空的下拉框
	_self.append("<select class=pro></select><label class=pro>省</label>");
	_self.append("<select class=ct></select><label class=ct>市</label>");
	_self.append("<select class=ar></select>");
	//分别获取3个下拉框
...
$.fn.ProvinceCity = function(){
	...
	_self.data("city2",["请选择", "请选择"]);
	//插入3个空的下拉框
	_self.append("<select class=new_pro></select><label>省</label>");
	_self.append("<select class=new_ct></select><label >市</label>");
	_self.append("<select class=new_ar></select>");
	//分别获取3个下拉框
	var $sel1 = _self.find("select").eq(0);
	var $sel2 = _self.find("select").eq(1);
	var $sel3 = _self.find("select").eq(2);
