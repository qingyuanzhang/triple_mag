...
class selling_poll(models.Model):
    ...
    value = models.DecimalField(max_digits=10,decimal_places=2,null=False,verbose_name='单价')
...
class income_record(models.Model):
    ...
    amount = models.DecimalField(max_digits=10,decimal_places=2,null=False,blank=False,verbose_name='股票数额')
...
class trend_record(models.Model):
    value = models.DecimalField(max_digits=10,decimal_places=2,null=False,default=1.00,verbose_name='股票单价')
