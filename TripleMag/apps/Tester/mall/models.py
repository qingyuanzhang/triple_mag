...
class Product(models.Model):
    ...
    name = models.CharField(max_length=50,null=False,blank=False,unique=True,verbose_name='产品名')
    image_url = models.ImageField(upload_to="static/images",null=True, blank=True,verbose_name='上传图片')
    #Detail info.
...
class Order(models.Model):
    ...
    transport_ways = models.CharField("配送方式",max_length=20,null=False,blank=False,choices=EnumTransWays,default="self-pickup")
