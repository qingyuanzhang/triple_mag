...
class value_setting(models.Model):
    ...
    stock_value_now = models.DecimalField(max_digits=10,decimal_places=4,null=False,default=1.0000,verbose_name='当日股票单价')
    stock_value_delta = models.DecimalField(max_digits=10,decimal_places=4,null=False,default=0.01,verbose_name='允许卖出价偏离单价量')
    ...
    mall_tax_rate = models.DecimalField(max_digits=2,decimal_places=2,default=0.07,null=False,verbose_name='C网奖金抽税比例')
    #--------------------------
    #Function switch
    #--------------------------
